...
// Get local cover URL for a sample book (stored in /public/sample-books/covers/)
export function getSampleBookCoverUrl(id: string): string {
  return `/sample-books/covers/${id}.jpg`
}
